...
if numel(p) > 1
    error('get function does not yet support arrays of spotQualityAssessment objects')
end
...
if nargin == 1
    ...
    error([strField, ' is not a valid and public spotQualityAssessment property']);
end
