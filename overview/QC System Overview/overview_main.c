 ...
 * Date: Mon May 01 15:20:34 2006
 * Arguments: "-B" "macro_default" "-m" "-W" "main" "-T" "link:exe" "-d"
 * "C:\PamSoft\DataAnalysis\overview\qcsystem" "overview" 
 */
...
extern const char *__MCC_overview_lib_path_data[];
extern const int __MCC_overview_lib_path_data_count;
 ...
 */
#ifndef LIB_overview_C_API 
#define LIB_overview_C_API /* No special import/export declaration */
#endif
...
)
{
    ...
    if (!mclInitializeComponentInstance(&_mcr_inst,
                                        ...
                                        __MCC_overview_lib_path_data,
                                        __MCC_overview_lib_path_data_count,
