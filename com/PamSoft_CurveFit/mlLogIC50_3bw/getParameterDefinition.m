...
pdef(10).name   = 'Ymax_initial';
pdef(10).dft    = 1;

pdef(11).name   = 'Ymax_auto';
pdef(11).dft    = uint8(1);
pdef(11).enumVal = uint8([0,1]);
pdef(11).enumMap = {'no', 'yes'};

pdef(12).name   = 'logIC50_auto';
pdef(12).dft    = uint8(1);
pdef(12).enumVal = uint8([0,1]);
pdef(12).enumMap = {'no', 'yes'};

pdef(13).name = 'logIC50_initial';
pdef(13).dft = -7;
